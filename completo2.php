...
//$paymentId = "PAYID-LTREC2Y6L203605VV4285337";
//$PayerID="8STMEP7LTCVRG";
include 'getToken.php';
$data2='{
	"payer_id": "'.$PayerID.'"
}';
/*
curl -v  https://api.sandbox.paypal.com/v1/payments/payment/PAYID-LTRDXOA8CH183676P9573548/execute/ \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer A21AAF-tgdvm0Z7TxZk04rWNZZ_XIW90DmSfNonGTV774JPY0iXToXy_DML_wj4ZjirtptL6O5Xz0tKsRWO6x5RJ3bb2lqxHA" \
  -d '{
  "payer_id": "8STMEP7LTCVRG"
}'
*/
$ch = curl_init();
